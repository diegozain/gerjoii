...
%------------------
parame_.natu.epsilon_z  = [2 2 2 2 2 10]; % between 4 & 1 
...
% ------------------
parame_.w.fo = 250e6; % 250e6 270e6 300e6 400e6. dispersion: 400e6. % [Hz]
parame_.w.nt = 3000; % 1500. 1900. 1050. dispersion: 4000.
% ------------------
% pml padding
% ------------------
parame_.w.pml_w = 60;
