...
# ------------------------------------------------------------------------------
# upload path local
push_path="$big_project_name/models-ml/pics-ml/"
# ------------------------------------------------------------------------------
cd $push_path
# ------------------------------------------------------------------------------
ls
echo what data do you want \(e.g. pics-data\)?
read data_folder
# ------------------------------------------------------------------------------
zip -r $data_folder.zip $data_folder >/dev/null
# ------------------------------------------------------------------------------
# upload path remote
push_path_="$server_path_/gerjoii/field/$push_path"
# ------------------------------------------------------------------------------
scp $data_folder.zip $push_path_
# ------------------------------------------------------------------------------
