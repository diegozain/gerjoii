...
# ------------------------------------------------------------------------------
cd $big_project_name/model-generator/nature-synth/mat-file/
ls
# ------------------------------------------------------------------------------
echo which small project \(eg, t2 or s5\)?
read small_project_name
# ------------------------------------------------------------------------------
push_path_="gerjoii/field/$big_project_name/model-generator/nature-synth/mat-file/"
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
scp -r $small_project_name $server_path
# scp *.mat $server_path/
# ------------------------------------------------------------------------------
cd ../../../../
# ------------------------------------------------------------------------------
