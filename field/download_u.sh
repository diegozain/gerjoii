...
down_path_="$big_project_name/$small_project_name/scripts/wavefield/u/"
down_path_="gerjoii/field/$down_path_"
# download path local
down_path="$big_project_name/$small_project_name/wavefield/u/"
if [ ! -d "$down_path" ]; then
  mkdir -p $down_path
fi
# ------------------------------------------------------------------------------
...
scp $scp_this .
# ------------------------------------------------------------------------------
printf "\n\n%-4syour wavefields were downloaded from:\n\n"
echo $scp_this
printf "\n\n%-4syour wavefields were downloaded in:\n\n"
echo $down_path
printf "\n%-3s-----------------\n\n\n"
# ------------------------------------------------------------------------------
printf "\n%-1syou should also run download_reco.sh (for s_r) and download.sh (for x and z)\n\n\n"
# ------------------------------------------------------------------------------
cd ../../../../
# ------------------------------------------------------------------------------
