function [parame_,gerjoii_] = dc_image_2d_(geome_,parame_,finite_,gerjoii_)
...
while (E_>tol_error & iter<tol_iter)
  E_ = 0;
  % compute update
  gerjoii_ = dc_update_2d(geome_,parame_,finite_,gerjoii_);
  % figure; fancy_imagesc(gerjoii_.dc.dsigma',geome_.X,geome_.Y);
  % pause;
  % update
