function finite_ = dc_L(parame_,finite_,gerjoii_)
  %
  %   diego domenzain
  %   spring 2017
  ...
  [ALPHAS,corners] = alphas(n,m,DELTAS,s_dc);
...
%-------------------------------------------------------------------------%
    ...
    finite_.dc.L = -Ldc;
    finite_.dc.ALPHAS = ALPHAS;
    finite_.dc.corners = corners;
end
...
function [ALPHAS,corners] = alphas(n,m,DELTAS,s_dc)
%
%   diego domenzain
%   spring 2017
%   Boise State University
