function gerjoii_ = dc_update2_5d__(geome_,parame_,finite_,gerjoii_)
% diego domenzain
% fall 2019 @ BSU
% ..............................................................................
% parfor loop (sources)
...
steps  = zeros( 1 , n_exp );
v_currs= zeros(geome_.n*geome_.m , n_exp);
% loop over all experiments
parfor i_e=1:n_exp;
  [dsigma,step_,Edc,v_curr] = dc_update2_5d(geome_,parame_,finite_,gerjoii_,i_e);
  % obj
  E_(i_e) = Edc;
  % step size
  steps(i_e) = step_;
...
gerjoii_.dc.v_curr = reshape( v_curr,[geome_.n,geome_.m] );
