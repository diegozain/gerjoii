function [parame_,finite_,geome_] = w_geom(parame_)
% diego domenzain.
% boise state university, 2018.
% ..............................................................................
% builds geometry parameters for the EM wave solver.
% ..............................................................................
geome_ = struct;
...
parame_.w.eps_max_ = max(epsi_all); % [ ]
parame_.w.eps_min_ = min(epsi_all); % [ ]
% - 
...
fprintf('fo [Hz] = %2.1e \n',parame_.w.fo);
fprintf('eps max [ ] = %2.1f\n',max(epsi_all));
fprintf('eps min [ ] = %2.1f\n',min(epsi_all));
fprintf('\n');
