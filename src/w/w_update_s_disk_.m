function gerjoii_ = w_update_s_disk_(geome_,parame_,finite_,gerjoii_)
% diego domenzain.
...
parfor is=1:ns
  [step_w_s,Es] = w_update_s_disk(geome_,parame_,finite_,gerjoii_,is);
...
% gerjoii_.w.dsigma = gerjoii_.w.dsigma + 0.5*gerjoii_.w.dsigma_;
