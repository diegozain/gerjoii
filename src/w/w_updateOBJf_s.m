function [dsigma,step_w_s,Es] = w_updateOBJf_s(geome_,parame_,finite_,gerjoii_,is)
% diego domenzain.
...
for iw_=1:numel(gerjoii_.w.obj_FNCs)
  ...
  % filter wavefields
  % ............................................................................
  if strcmp(gerjoii_.w.obj_FNC,'FREQstp')
    fo = gerjoii_.w.regu.Fpi;
  ...
  lo = parame_.w.c/sqrt(parame_.w.epsilon( s(1),s(2) )) / fo;  % [m]
