...
elseif strcmp(src_TYPE,'xLINEAR_SOME')
  ...
  if ns > 1
    ...
    %...........................................................................
    for i_=2:ns+1
      sources_real(i_,1) = sources_real(i_-1,1) + ds;
    end
  else
    sources_real = zeros(ns,2);
    sources_real(1,1) = parame_.bb/2;
  end
elseif strcmp(src_TYPE,'xLINEAR_SRCS_RECS')
  %
  % r-r-r-r-r-r-r-r-r-r
  % s --- s --- s --- s
  %.............................................................................
  receivers_x = x(1):lo4:x(end);
  sources_real = zeros(ns,2);
  %.............................................................................
  ds = ((parame_.bb-source_xz(1)) - source_xz(1)) / ns;
  %.............................................................................
  sources_real = zeros(ns,2);
  sources_real(1,1) = receivers_x(binning(receivers_x,source_xz(1)));
  %...........................................................................
  for i_=2:ns
    sources_real(i_,1) = receivers_x(binning(receivers_x,sources_real(i_-1,1)+ ds));
  end
end % if src_TYPE
%...............................................................................
%     binned
