function [parame_,gerjoii_] = wdc_imageOBJef_2d(geome_,parame_,finite_,gerjoii_)
% diego domenzain.
...
if isfield(gerjoii_,'linker')
  ...
  dEs_ = gerjoii_.w.dEs_;
  Es__ = gerjoii_.w.Es__;
else
  E  = [];
  E_ = Inf;
  as = zeros(2,2);
...
while (E_>tol_error & iter<tol_iter)
  ...
  % ............................................................................
  % conductivity & permittivity frequency-gradient setup
  % ............................................................................
  gerjoii_ = w_freqchoose(gerjoii_,parame_,iter,dEs_);
  if strcmp(gerjoii_.w.regu.f_yesno,'NO')
    if numel(gerjoii_.w.obj_FNCs)>=3
      gerjoii_.w.obj_FNCs(3) = [];
      gerjoii_.w.g_s_weights(3) = [];
      gerjoii_.w.g_e_weights(3) = [];
    end
  else
    % % some fancy way to get weights here
    % gerjoii_.w.g_s_weights(3) = ;
    % gerjoii_.w.g_e_weights(3) = ;
  end
  % ............................................................................
  % conductivity update
  % ............................................................................
  gerjoii_ = w_updateOBJf_s_(geome_,parame_,finite_,gerjoii_);
  gerjoii_ = dc_update_2d__(geome_,parame_,finite_,gerjoii_);
  fprintf('\n just computed dsigma_w & dsigma_dc');
  % ............................................................................
  % for conductivity & permittivity frequency-gradient setup
  dEs_ = gerjoii_.w.Es_ - Es__;
  Es__ = gerjoii_.w.Es_;
  % ............................................................................
  ...
  % ............................................................................
  % clean up frequency stuff
  % ............................................................................
  if isfield(gerjoii_.w,'dsigma_freq')
    gerjoii_.w = rmfield(gerjoii_.w,'dsigma_freq');
  end
  % ............................................................................
  ...
  % permittivity update
  % ............................................................................
  gerjoii_ = w_updateOBJf_e_(geome_,parame_,finite_,gerjoii_);
  % ............................................................................
  ...
  % clean up frequency stuff
  % ............................................................................
  if isfield(gerjoii_.w,'depsi_freq')
    gerjoii_.w = rmfield(gerjoii_.w,'depsi_freq');
  end
  % ............................................................................
  % obj
  % ............................................................................
...
%
gerjoii_.w.dEs_ = dEs_;
gerjoii_.w.Es__ = Es__;
end
