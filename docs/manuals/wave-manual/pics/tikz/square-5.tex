...
\node[draw=black,fill=nblue!40,minimum width=1.5em,minimum height=1.5em,rectangle]  at (2em,2.5em) {}; % height=4em
%
%\node[]  at (5em,0) {${\bf E}_z$};
%
\draw[] (-4em,3.2em) -- (-4em,4em);
\node[rotate=90]  at (-4.5em,3.5em) {\small{\sf 2}};
 \draw[] (-6em,1.8em) -- (-6em,4em);
 \node[rotate=90]  at (-6.5em,3em) {\small{\sf nx}};
\draw[] (-3.5em,-4.5em) -- (1em,-4.5em);
\node[]  at (-1em,-5.2em) {\small{\sf pje}};
\draw[] (-3.5em,-6em) -- (3em,-6em);
\node[]  at (-2.4em,-6.8em) {\small{\sf ny}};
%
\end{tikzpicture}
%\\\\
%\odot \;\; = \;\; \dots \;\; + \;\; - \;\; (\]
